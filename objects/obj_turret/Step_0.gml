...
if(mouse_check_button_pressed(mb_right) && laserReady = true)
{
	//audio de laser
	var instance_laser = instance_create_layer(x,y,"PlayerProjectile",obj_laser);
	instance_laser.direction = direction;
	instance_laser.image_angle = direction-90;
	laserReady = false;
