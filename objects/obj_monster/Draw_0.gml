...
if(global.quest_active == true)
{
	...
	/// @DnDArgument : "number" "quest_item_amount[0]"
	/// @DnDSaveInfo : "sprite" "spr_quest_blue"
	var l58A154D6_0 = sprite_get_height(spr_quest_blue);
	var l58A154D6_1 = 0;
	for(var l58A154D6_2 = quest_item_amount[0]; l58A154D6_2 > 0; --l58A154D6_2) {
		draw_sprite(spr_quest_blue, 0, x-32, y+130 + l58A154D6_1);
	...
	/// @DnDArgument : "stackorder" "1"
	/// @DnDArgument : "number" "quest_item_amount[1]"
	/// @DnDSaveInfo : "sprite" "spr_quest_purple"
	var l45F18403_0 = sprite_get_height(spr_quest_purple);
	var l45F18403_1 = 0;
	for(var l45F18403_2 = quest_item_amount[1]; l45F18403_2 > 0; --l45F18403_2) {
		draw_sprite(spr_quest_purple, 0, x, y+130 + l45F18403_1);
	...
	/// @DnDArgument : "stackorder" "1"
	/// @DnDArgument : "number" "quest_item_amount[2]"
	/// @DnDSaveInfo : "sprite" "spr_quest_green"
	var l7A1644B5_0 = sprite_get_height(spr_quest_green);
	var l7A1644B5_1 = 0;
	for(var l7A1644B5_2 = quest_item_amount[2]; l7A1644B5_2 > 0; --l7A1644B5_2) {
		draw_sprite(spr_quest_green, 0, x+32, x+130 + l7A1644B5_1);
